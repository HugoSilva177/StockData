from etl.fundamentus_etl.src.dao.mongodb.AbstractMongoDAO import AbstractMongoDAO
from etl.fundamentus_etl import DAConexaoMongo
...
class CotacaoEmpresaDAO(AbstractMongoDAO):
    ...
    def buscar_cotacao_empresa_por_id_cotacao(self, id_cotacao):
        cotacao_por_id = self.__colecao_mongo.find_one({"_id": id_cotacao})
        return cotacao_por_id
