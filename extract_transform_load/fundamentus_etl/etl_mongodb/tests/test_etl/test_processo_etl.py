import pytest
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src import ProcessoETL

from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src.dao.mongodb.IndicadoresDAO import IndicadoresDAO
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src import InfoEmpresaDAO
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src import BalancoEmpresaDAO
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src import CotacaoEmpresaDAO
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src.dao.mongodb.OscilacoesEmpresaDAO import OscilacoesEmpresaDAO

from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src.dao.hadoop_hdfs.InfoEmpresaHDFS import InfoEmpresaHDFS
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src import CotacaoEmpresaHDFS
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src import BalancoEmpresaHDFS
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src.dao.hadoop_hdfs.OscilacoesEmpresaHDFS import OscilacoesEmpresaHDFS
from extract_transform_load_mongo.fundamentus_etl.etl_mongodb.src.dao.hadoop_hdfs.IndicadoresEmpresaHDFS import IndicadoresEmpresaHDFS
