import json
from extract_transform_load.fundamentus_etl.etl_mongodb.src.etl.InfoEmpresaETL import InfoEmpresaETL
from extract_transform_load.fundamentus_etl.etl_mongodb.src.etl.CotacaoEmpresaETL import CotacaoEmpresaETL
from extract_transform_load.fundamentus_etl.etl_mongodb.src.etl.BalancoEmpresaETL import BalancoEmpresaETL
from extract_transform_load.fundamentus_etl.etl_mongodb.src.etl.OscilacoesEmpresaETL import OscilacoesEmpresaETL
from extract_transform_load.fundamentus_etl.etl_mongodb.src.kafka.WebScrapingConsumer import WebScrapingConsumer
from extract_transform_load.fundamentus_etl.etl_mongodb.src.etl.IndicadoresEmpresaETL import IndicadoresEmpresaETL
