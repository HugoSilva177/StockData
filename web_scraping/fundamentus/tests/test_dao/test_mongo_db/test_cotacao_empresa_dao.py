...
class TestCotacaoEmpresaDAO:
    ...
    def empresa_mongodb(self, request):
        return request.param

    def test_deve_buscar_dados_de_cotacao_e_balanco_por_papel_e_data_e_retornar_dicionario(self, empresa_mongodb):
        papel_esperado = 'PETR4'
        cotacao_empresa_colecao = empresa_mongodb.buscar_dados_empresa(papel_esperado, '01/03/2021')
