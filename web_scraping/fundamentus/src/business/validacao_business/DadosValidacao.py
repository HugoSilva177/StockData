...
class DadosValidacao:
    ...
    def __init__(self, papel, info_empresa_dao, cotacao_empresa_dao, balanco_empresa_dao):
        self.__papel = papel
    ...
    def validacao_dados_empresa(self):
        id_dados_empresa = EmpresaBusiness.verificar_dados_empresa_exitem(self.__papel, self.__info_empresa_dao)
        print('-------------------------------------')
    ...
    def __validacao_dados_cotacao(self):
        if EmpresaBusiness.verificar_ultima_cotacao_existe(self.__papel, self.__cotacao_empresa_dao):
            ...
            if EmpresaBusiness.verificar_ultimo_balanco_existe(self.__papel, self.__balaco_empresa_dao):
