...
class BalancoEmpresaScraping(WebScraping):
    ...
    def extrair_dados_label(self):
        balanco_label = self.get_html_selector().xpath(
        ...
        dre_12_meses = self.get_html_selector().xpath(
        ...
        dre_3_meses = self.get_html_selector().xpath(
            "//table[5]//td[@class='label w2']//span[@class='txt']/text() | "
    ...
    def extrair_dados_valores(self):
        balanco_dados = self.get_html_selector().xpath(
